    ...
    return (
      ...
      <div style={{ padding:16,paddingBottom:100 }}>
        ...
        {dayHabits.length === 0 ? (
          ...
          return (
            <div key={habit.id} style={{ ...styles.card,borderLeft:`3px solid ${col}`,marginBottom:4,padding:"5px 7px" }}>
              <div style={{ display:"flex",alignItems:"center",gap:6 }}>
                <div onClick={()=>setDetailHabitId(habit.id)} style={{ display:"flex",alignItems:"center",gap:6,flex:1,minWidth:0,cursor:"pointer" }}>
                  <div style={{ width:16,height:16,borderRadius:4,flexShrink:0,background:`${col}18`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:9 }}>{habit.icon||"🔁"}</div>
                  <div style={{ minWidth:0,flex:1 }}>
                    <div style={{ fontSize:11,fontWeight:700,color:T.text,whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis",display:"flex",alignItems:"center",gap:3 }}>
                ...
                {isFutureDay ? (
                  ...
                  <div style={{ display:"flex",gap:3,flexShrink:0 }}>
                    <button onClick={()=>setHabitStatus(habit.id,"done",viewedDateStr)} style={{ width:22,height:22,borderRadius:6,border:isDone?"none":`1.5px solid ${T.success}40`,background:isDone?T.success:`${T.success}12`,color:isDone?"#fff":T.success,fontWeight:700,fontSize:11,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:0 }}>✓</button>
                    <button onClick={()=>setHabitStatus(habit.id,"partial",viewedDateStr)} style={{ width:22,height:22,borderRadius:6,border:isPartial?"none":`1.5px solid ${T.warning}40`,background:isPartial?T.warning:`${T.warning}12`,color:isPartial?"#fff":T.warning,fontWeight:700,fontSize:11,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:0 }}>~</button>
                    <button onClick={()=>{ setHabitStatus(habit.id,"failed",viewedDateStr); setShowFailInput(habit.id); }} style={{ width:22,height:22,borderRadius:6,border:isFailed?"none":`1.5px solid ${T.danger}40`,background:isFailed?T.danger:`${T.danger}12`,color:isFailed?"#fff":T.danger,fontWeight:700,fontSize:11,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",padding:0 }}>✕</button>
                  </div>
                )}
