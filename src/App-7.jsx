...
export default function TitinFocusApp() {
  ...
  return (
    <div style={{ background:T.bg,minHeight:"100dvh",maxWidth:480,margin:"0 auto",fontFamily:"'Segoe UI', system-ui, sans-serif",color:T.text,position:"relative",display:"flex",flexDirection:"column" }}>
      ...
      {/* Nav */}
      <div style={{ position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",width:"100%",maxWidth:480,background:`${T.bgCard}f5`,borderTop:`1px solid ${T.border}`,display:"flex",padding:"4px 4px 6px",backdropFilter:"blur(10px)",zIndex:20,overflowX:"auto",scrollbarWidth:"none" }}>
        {tabs.map(t => (
