...
export default function TitinFocusApp() {
  ...
  function NewHabitModal() {
    const [form, setForm] = useState({ name: "", icon: "🔁", startTime: "", endTime: "", days: [0,1,2,3,4,5,6], xp: 30, difficulty: 4 });
  ...
  function HomeTab() {
    ...
    return (
      <div style={{ padding:16,paddingBottom:100 }}>
        ...
        {/* Estado vazio: conta nova, sem habitos nem tarefas */}
        {todayHabits.length === 0 && tasksTotal === 0 && (
          <div style={{ ...styles.card,marginTop:12 }}>
            ...
            <div style={{ color:T.textMuted,fontSize:12,marginBottom:14,lineHeight:1.5 }}>Cadastre seus primeiros habitos e tarefas para ganhar XP, subir de nivel e ver seu progresso aqui na tela inicial.</div>
            <div style={{ display:"flex",gap:8,marginBottom:14 }}>
              <button onClick={()=>setTab("habits")} style={{ ...styles.btnSolid(T.accent),flex:1 }}>🔁 Criar habito</button>
              <button onClick={()=>setTab("tasks")} style={{ ...styles.btnSolid(T.success),flex:1 }}>✅ Criar tarefa</button>
            </div>
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:10 }}>
              <div style={{ display:"flex",gap:10,alignItems:"flex-start" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize:11,color:T.textMuted }}>Coisas que voce repete todo dia — treino, leitura, estudo.</div>
                </div>
              </div>
              <div style={{ display:"flex",gap:10,alignItems:"flex-start" }}>
                <span style={{ fontSize:16 }}>✅</span>
                <div>
                  <div style={{ fontSize:12,fontWeight:700,color:T.text }}>Tarefas</div>
                  <div style={{ fontSize:11,color:T.textMuted }}>Coisas pontuais do dia — use o "📋 Importar" pra cadastrar varias de uma vez.</div>
                </div>
              </div>
              <div style={{ display:"flex",gap:10,alignItems:"flex-start" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize:11,color:T.textMuted }}>Cada habito/tarefa concluida da XP. Acumule XP pra subir de nivel e de classe.</div>
                </div>
              </div>
            </div>
          </div>
