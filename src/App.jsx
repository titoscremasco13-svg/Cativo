  ...
  function HomeTab() {
    ...
    return (
      <div style={{ padding:16,paddingBottom:100 }}>
        ...
        {/* Frase do dia */}
        <div style={{ ...styles.card,background:`linear-gradient(135deg, #0c0420, #080c10)`,border:`1px solid ${T.purple}30` }}>
    ...
    return (
      <div style={{ padding:16,paddingBottom:100 }}>
        ...
        {isViewingToday && top5Dia.length > 0 && (
          <div style={{ ...styles.card,background:`linear-gradient(135deg, #0c1000, #080c10)`,border:`1px solid ${T.gold}30`,marginBottom:10 }}>
        ...
        {dayHabits.length === 0 ? (
          ...
          return (
            <div key={habit.id} style={{ ...styles.card,border:`1px solid ${col}30`,marginBottom:8 }}>
              <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:8 }}>
                <div style={{ flex:1 }}>
                  <div style={{ fontSize:13,fontWeight:700,color:T.text }}>{habit.icon||"🔁"} {habit.name}</div>
